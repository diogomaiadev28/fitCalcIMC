    ...
    <main class="flex justify-center items-center flex-col h-full">
        <form method="POST" class="bg-gray-100 rounded-2xl w-100 p-8 flex flex-col justify-center space-y-4">
            <div class="flex flex-col justify-center items-center space-y-3 mb-10">
                ...
                <p class="text-sm">Preencha seus dados</p>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="user_fullname" class="pl-8 py-2 w-full bg-white border border-gray-200 rounded-lg text-sm font-medium"
            ...
            <div class="mb-3 position-relative">
                ...
                <div class="relative">
                    ...
                    <input type="password" name="userConfirmPassword"
                        class="pl-8 py-2 w-full bg-white border border-gray-200 rounded-lg text-sm font-medium" id="userConfirmPassword"
                        placeholder="Confirme sua senha">
                </div>
            </div>

            <button type="submit" class="cursor-pointer hover:opacity-90 transition duration-200 bg-gradient-to-br from-[#667eea] to-[#764ba2] text-white font-semibold text-sm p-3 rounded-lg">Cadastrar</button>

            <p class="text-sm text-center">Já tem uma conta? <a class="text-blue-600 font-semibold hover:underline" href="../index.php">Faça login aqui</a></p>
            </div>
        </form>
        <p></p>
    </main>
